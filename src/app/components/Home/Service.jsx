    ...
    return (
        <section className='md:h-40 bg-[#F6F3F2] grid place-content-center'>
                <ul className='flex flex-col md:flex-row gap-4 '>
                    <li><Link href="/contact-us/request-test-drive" className='w-72 h-14 bg-lightDark grid place-content-center text-[white] text-sm'>Request a Test Drive</Link></li>
                ...
                <li><Link href="/contact-us/prices" className='w-72 h-14 bg-lightDark grid place-content-center text-[white] text-sm'>Prices</Link></li>
                </ul>
        </section>
    );
};
