    ...
    return (
        <div className="container space-y-8">
                    ...
                    <section className="space-y-4">
                            ...
                            <p>The Website may contain links to Applications/websites owned or operated by third parties, including owned or operated by third party service providers affiliated with HMIL. We take no responsibility for the privacy practices or content of other Applications/websites. Other Applications/websites may contain their own privacy policies and their owners or operators are responsible for informing you about their security and privacy practices. We recommend that you thoroughly read the privacy policies of these third party applications/websites.</p>

                            <p>HMIL may change this Privacy Policy from time to time. If we make any substantial changes, we will notify you by posting a prominent announcement on our website.</p>

                            <p>Corrections Upon request, HMIL will correct personal information that you might have disclosed and state that it is erroneous.</p>

                            <p>To request a correction send an e-mail to demo@mail.com or letter in writing at the following address:</p>
                            <CompanyAddress/>
                    </section>
        </div>
    );
